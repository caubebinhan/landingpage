...
class Redirection_Integration extends Integration {
 ...
 public function __construct() {
        $this->name = __( 'Redirection', 'simply-static-pro' );
        $this->description = __( 'Integrates redirections from the "Redirection" Plugin automatically on each export.', 'simply-static-pro' );
    }
   ...
   $static_page->set_status_message( __( 'Redirection URL', 'simply-static-pro' ) );
