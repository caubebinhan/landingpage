...
class Database_API extends API {
	...
	/**
	 * Get a git reference (e.g., heads/branch-name).
	 *
	 * @param string $owner Owner or organization.
	 * @param string $repository Repository name.
	 * @param string $ref Reference path (e.g., 'heads/main').
	 *
	 * @return array
	 */
	public function get_reference( $owner, $repository, $ref ) {
		$resource = 'repos/' . rawurlencode( $owner ) . '/' . rawurlencode( $repository ) . '/git/refs/' . $ref;
