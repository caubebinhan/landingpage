...
<div class="stage">
  ...
  <div class="copy">
    ...
    <section class="copy-scene">
      <div class="kicker"><?php esc_html_e('SCHEMA & CONTEXT AWARE', 'hoasen-theme'); ?></div>
      <h1><?php esc_html_e('The editor understands your query before it completes it.', 'hoasen-theme'); ?></h1>
      <p><?php esc_html_e('HoaSen reads the live schema, follows the query context, and uses machine learning to adapt suggestions to the way you actually work.', 'hoasen-theme'); ?></p>
      <div class="chips">
    ...
    <section class="copy-scene">
      <div class="kicker"><?php esc_html_e('FULLY CUSTOM PLUGINS', 'hoasen-theme'); ?></div>
      <h1><?php esc_html_e('Shape the tool around your workflow.', 'hoasen-theme'); ?></h1>
      <p><?php esc_html_e('Plugins are fully custom and live inside the workspace, so teams can add exactly the tools they need without losing the active query.', 'hoasen-theme'); ?></p>
      <div class="chips">
    ...
    <section class="copy-scene">
      <div class="kicker"><?php esc_html_e('CREATIVE WIDGETS', 'hoasen-theme'); ?></div>
      <h1><?php esc_html_e('Use widgets as a creative workspace layer.', 'hoasen-theme'); ?></h1>
      <p><?php esc_html_e('Keep the UI minimal, then add, remove, or rearrange widgets to surface the context your workflow actually needs.', 'hoasen-theme'); ?></p>
      <div class="chips">
